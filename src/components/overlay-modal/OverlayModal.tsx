...
export const OverlayModal = ({ children, additionalClass }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center">
      <div className={`w-9/10 mx-auto rounded-lg py-4 overflow-auto bg-accent-dark relative border border-primary shadow-md shadow-secondary ${additionalClass ? additionalClass : ''}`}>
